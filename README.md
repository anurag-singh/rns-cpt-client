=== Rns Cpt Client ===
Contributors: [anurag-singh](http://www.anuragsingh.me/)
...
1. Upload `rns-cpt-client.php` to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Place `<?php do_action('rns_cpt_client_hook'); ?>` in your templates
